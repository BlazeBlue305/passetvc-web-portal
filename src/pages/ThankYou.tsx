      ...
      <div className="max-w-2xl mx-auto text-center text-white">
        ...
        <div className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
          <Button 
            ...
            size="lg" 
            onClick={() => navigate('/')}
            className="w-full md:w-auto h-14 text-lg font-semibold"
          >
            Back to Home
          </Button>
          <Button 
            ...
            size="lg" 
            onClick={() => navigate('/')}
            className="w-full md:w-auto h-14 text-lg font-semibold bg-white/10 text-white border-white/30 hover:bg-white/20"
          >
            Learn More
          </Button>
        </div>
